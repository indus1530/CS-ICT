package edu.aku.hassannaqvi.cs_ict.core;
...
import edu.aku.hassannaqvi.cs_ict.contracts.AreasContract.singleAreas;
import edu.aku.hassannaqvi.cs_ict.contracts.BLRandomContract;
import edu.aku.hassannaqvi.cs_ict.contracts.BLRandomContract.SingleRandomHH;
import edu.aku.hassannaqvi.cs_ict.contracts.ChildContract;
import edu.aku.hassannaqvi.cs_ict.contracts.ChildContract.ChildTable;
import edu.aku.hassannaqvi.cs_ict.contracts.DistrictContract;
import edu.aku.hassannaqvi.cs_ict.contracts.EnumBlockContract;
import edu.aku.hassannaqvi.cs_ict.contracts.EnumBlockContract.EnumBlockTable;
import edu.aku.hassannaqvi.cs_ict.contracts.FamilyMembersContract;
import edu.aku.hassannaqvi.cs_ict.contracts.FamilyMembersContract.SingleMember;
import edu.aku.hassannaqvi.cs_ict.contracts.FormsContract;
import edu.aku.hassannaqvi.cs_ict.contracts.FormsContract.FormsTable;
import edu.aku.hassannaqvi.cs_ict.contracts.TalukasContract;
import edu.aku.hassannaqvi.cs_ict.contracts.UCsContract;
import edu.aku.hassannaqvi.cs_ict.contracts.UsersContract;
import edu.aku.hassannaqvi.cs_ict.contracts.VersionAppContract;
import edu.aku.hassannaqvi.cs_ict.contracts.VillagesContract.SingleVillage;

import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.DATABASE_NAME;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.DATABASE_VERSION;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_BL_RANDOM;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_CHILD_TABLE;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_DISTRICTS;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_FAMILY_MEMBERS;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_FORMS;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_PSU_TABLE;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_USERS;
import static edu.aku.hassannaqvi.cs_ict.utils.CreateTable.SQL_CREATE_VERSIONAPP;
