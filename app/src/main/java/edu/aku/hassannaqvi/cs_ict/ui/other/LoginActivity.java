package edu.aku.hassannaqvi.cs_ict.ui.other;
...
import edu.aku.hassannaqvi.cs_ict.core.AppInfo;
import edu.aku.hassannaqvi.cs_ict.core.DatabaseHelper;
import edu.aku.hassannaqvi.cs_ict.core.MainApp;
import edu.aku.hassannaqvi.cs_ict.ui.sync.SyncActivity;
import edu.aku.hassannaqvi.cs_ict.utils.AndroidUtilityKt;
import kotlin.Pair;
import kotlin.Unit;
import kotlin.coroutines.CoroutineContext;

import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.LOGIN_SPLASH_FLAG;
import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.MINIMUM_DISTANCE_CHANGE_FOR_UPDATES;
import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.MINIMUM_TIME_BETWEEN_UPDATES;
import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_CONTACTS;
import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_PHONE_STATE;
import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.TWO_MINUTES;
import static edu.aku.hassannaqvi.cs_ict.repository.SplashRepositoryKt.populatingSpinners;
...
import static edu.aku.hassannaqvi.cs_ict.utils.UtilKt.getPermissionsList;
