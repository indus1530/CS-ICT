package edu.aku.hassannaqvi.cs_ict.contracts;
...
public class FormsContract extends LiveData<FormsContract> {
    ...
    public static final String CONTENT_AUTHORITY = "edu.aku.hassannaqvi.cs_ict_hh";
    public static final String PATH_FORMS = "forms";
    private final String projectName = "CS-ICT_HH";
    private String _ID = "";
    private String _UID = "";
