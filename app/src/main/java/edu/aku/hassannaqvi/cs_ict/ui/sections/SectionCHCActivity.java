...
import edu.aku.hassannaqvi.cs_ict.databinding.ActivitySectionChCBinding;
import edu.aku.hassannaqvi.cs_ict.datecollection.AgeModel;
import edu.aku.hassannaqvi.cs_ict.datecollection.DateRepository;
import edu.aku.hassannaqvi.cs_ict.ui.other.ChildEndingActivity;
import edu.aku.hassannaqvi.cs_ict.ui.other.TakePhoto;
import edu.aku.hassannaqvi.cs_ict.utils.DateUtils;
import edu.aku.hassannaqvi.cs_ict.utils.EndSectionActivity;
import kotlin.Pair;

import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.CHILD_ENDING_AGE_ISSUE;
import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.IM01FLAG;
import static edu.aku.hassannaqvi.cs_ict.CONSTANTS.IM02CARDSEEN;
...
import static edu.aku.hassannaqvi.cs_ict.utils.UtilKt.openWarningActivity;
    ...
    public void BtnContinue() {
        ...
        if (formValidation()) {
            ...
            if (child.getCalculatedDOB() != null || dtInstant != null) {
                ...
                monthFlag = totalMonths >= 4 && totalMonths <= 11;
            }
            if (monthFlag) {
                try {
                    SaveDraft();
