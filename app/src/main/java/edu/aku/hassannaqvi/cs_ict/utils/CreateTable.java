package edu.aku.hassannaqvi.cs_ict.utils;
...
public final class CreateTable {
    ...
    public static final String DATABASE_NAME = "cs_ict_hh.db";
    public static final String DB_NAME = "cs_ict_hh_copy.db";
    public static final String PROJECT_NAME = "CS-ICT_HH";
